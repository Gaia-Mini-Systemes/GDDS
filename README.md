...
Vous retrouvez les commandes traitées par GDDS, vous pouvez egalement passer par WRKREGINF ou par NAVIGATOR For i .
Mais vous aurez un assistant  
#### Remarques
...
Gestion des directives de compilation.
    ...
    RPLDDSINS remplacer les directives d'un source 
